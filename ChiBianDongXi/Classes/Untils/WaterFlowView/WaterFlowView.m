...
- (id)initWithFrame:(CGRect)frame headerViewHeight:(CGFloat)height
{
    self = [super initWithFrame:frame];
    if (self) {
        // Initialization code
        self.delegate = self;
        _heightTillNow = height;
    }
    return self;
}
...
- (void)tap:(UITapGestureRecognizer *)cell
{
    WaterFlowViewCell * tapCell = (WaterFlowViewCell *)cell.view
    ;
    [_waterFlowDelegate waterFlowView:self didSelectRowAtIndexPath:tapCell.indexPath];
}
