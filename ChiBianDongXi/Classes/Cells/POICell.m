...
{
    self.poiNameLabel = [[[UILabel alloc] initWithFrame:CGRectMake(kLabelMargin, kLabelMargin, 135, 20)] autorelease];
    
    self.poiImageView    = [[[AsynImageView alloc] init] autorelease];
    
    self.shareNumLabel= [[[UILabel alloc] initWithFrame:CGRectMake(kLabelMargin, 260, 140, 30)] autorelease];
    
    
    self.weiboLabel   = [[[UILabel alloc] initWithFrame:CGRectMake(kLabelMargin, 290, 140, 20)] autorelease];
    
    
    self.addressLabel = [[[UILabel alloc] initWithFrame:CGRectMake(kLabelMargin, 310, 55, 25)] autorelease];
    
    self.categoryLabel = [[[UILabel alloc] initWithFrame:CGRectMake(60, 310, 55, 25)] autorelease];
    
    self.priceLabel = [[[UILabel alloc] initWithFrame:CGRectMake(115, 310, 35, 25)] autorelease];
...
- (void)layoutSubviews
{
    ...
    self.poiImageView.frame = CGRectMake(kImageMargin, 3*kTopMargin+textSize.height, 145, newHeight);
    //异步加载图片
    ...
    self.shareNumLabel.frame = CGRectMake(kLabelMargin, 4*kTopMargin+textSize.height+newHeight, 140, 30);
...
//    NSLog(@"%f", 3*kTopMargin+textSize.height+newHeight+60);
    ...
    self.weiboLabel.frame = CGRectMake(kLabelMargin, 4*kTopMargin+textSize.height+newHeight+30, 140, 15);
    ...
    self.addressLabel.frame = CGRectMake(kLabelMargin, 4*kTopMargin+textSize.height+newHeight+50, 55, 25);
    self.addressLabel.font = [UIFont systemFontOfSize:11.0];
    self.addressLabel.text = self.poiIndo.poiDistrict;
    
    self.categoryLabel.frame = CGRectMake(60, 4*kTopMargin+textSize.height+newHeight+50, 55, 25);
    self.categoryLabel.font = [UIFont systemFontOfSize:11.0];
    self.categoryLabel.text = self.poiIndo.poiCategory;
    
    self.priceLabel.frame = CGRectMake(115, 4*kTopMargin+textSize.height+newHeight+50, 55, 25);
    ...
    self.cellHeight = 5*kTopMargin+textSize.height+newHeight+50;
...
+(CGFloat) cellHeight:(POIInfo *) poiInfo
{
    ...
    return (CGFloat)(textSize.height + imageHeight + 5*kTopMargin + 75);
